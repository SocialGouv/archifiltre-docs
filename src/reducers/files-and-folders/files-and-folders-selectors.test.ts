...
describe("files-and-folders-selectors", () => {
    ...
    describe("getFiles", () => {
        it("should filter out the folders", () => {
            ...
            expect(files).toEqual(
                expect.arrayContaining([child12, child11, child2])
            );
        });
    });
    ...
    describe("getFolders", () => {
        it("should filter out files", () => {
            ...
            expect(folders).toEqual(
                expect.arrayContaining([rootFolder, child1])
            );
        });
    });
    ...
    describe("findElementParent", () => {
        it("should return the element parent", () => {
            expect(
                findElementParent(child12Id, filesAndFoldersTestMap)
            ).toEqual(child1);
        });
    });
    ...
    describe("excludeChildNodes", () => {
        it("should remove the child nodes ids from the list", () => {
            ...
            const filesAndFoldersMap = {
                ...
                [nonIgnoredChildId]: createFilesAndFolders({
                    id: nonIgnoredChildId,
                }),
            ...
            expect(
                excludeChildNodes(elementIds, filesAndFoldersMap).sort()
