...
export const ADD_COMMENTS_ON_FILES_AND_FOLDERS = "FILES_AND_FOLDERS/ADD_COMMENTS";
...
export const MARK_ELEMENTS_TO_DELETE = "FILES_AND_FOLDERS/MARK_ELEMENTS_TO_DELETE";
export const UNMARK_ELEMENTS_TO_DELETE = "FILES_AND_FOLDERS/UNMARK_ELEMENTS_TO_DELETE";
export const INIT_VIRTUAL_PATH_TO_ID_MAP = "FILES_AND_FOLDERS/INIT_VIRTUAL_PATH_TO_ID_MAP";
export const REGISTER_ERRORED_ELEMENTS = "FILES_AND_FOLDERS/REGISTER_ERRORED_ELEMENTS";
export const RESET_ERRORED_ELEMENTS = "FILES_AND_FOLDERS/RESET_ERRORED_ELEMENTS";
export const OVERRIDE_LAST_MODIFIED = "FILES_AND_FOLDERS/OVERRIDE_LAST_MODIFIED";
export const INIT_OVERRIDE_LAST_MODIFIED = "FILES_AND_FOLDERS/INIT_OVERRIDE_LAST_MODIFIED";
export const RESET_OVERRIDE_LAST_MODIFIED = "FILES_AND_FOLDERS/RESET_OVERRIDE_LAST_MODIFIED";
