 ...
 * @param sortMethod
 */
export const setIcicleSortMethod = (sortMethod: IcicleSortMethod): IcicleSortMethodAction => ({
  sortMethod,
 ...
 * @param weightMethod
 */
export const setElementWeightMethod = (weightMethod: ElementWeightMethod): IcicleSortMethodAction => ({
 ...
 * @param colorMode
 */
export const setIcicleColorMode = (colorMode: IcicleColorMode): IcicleSortMethodAction => ({
  colorMode,
