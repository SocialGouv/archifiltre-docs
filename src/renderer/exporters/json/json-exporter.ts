...
import { getNameWithExtension, save } from "../../utils/file-system/file-sys-util";
...
export const jsonExporterThunk =
  ({ sessionName, originalPath, version }: JsonExporterThunkArgs): ArchifiltreDocsThunkAction =>
  (_, getState) => {
