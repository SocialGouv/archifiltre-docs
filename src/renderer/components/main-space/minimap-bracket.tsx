...
const _MinimapBracket: React.FC<MinimapBracketProps> = ({ zoomOffset, zoomRatio, viewportWidth, viewportHeight }) => {
  const rightRectangleStart = (zoomOffset + 1 / zoomRatio) * viewportWidth;
  const rectangleStyle = { fill: "black", opacity: "0.4" };

  return (
    <g>
      <rect x={0} y={0} width={viewportWidth * zoomOffset} height={viewportHeight} style={rectangleStyle} />
      <rect
