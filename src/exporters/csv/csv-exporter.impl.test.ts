...
describe("csv-exporter.impl", () => {
  describe("onInitialize", () => {
    ...
    it("should return the right csv with hashes", async () => {
      const asyncWorker = createAsyncWorkerMock();
      const csvHeader = `"";"path";"path length";"name";"extension";"size (octet)";"first_modified";"last_modified";"new path";"new name";"description";"file/folder";"depth";"number of files";"type";"hash (MD5)";"tag0 : ${tag2Name}";"tag1 : ${tagName}"`;
      const csvFirstLine = `"";"${formatPathForUserSystem(
        rootFolderId
      ...
      const csvThirdLine = `"";"${formatPathForUserSystem(
        ...
        comments[firstChildId]
      }";"file";"2";"1";"plain";"${firstChildIdHash}";"${tag2Name}";"${tagName}"`;
      const expectedCsv = [
        csvHeader,
        csvFirstLine,
        csvSecondLine,
    ...
    it("should handle elementsToDelete", async () => {
      const asyncWorker = createAsyncWorkerMock();
      const csvHeader = `"";"path";"path length";"name";"extension";"size (octet)";"first_modified";"last_modified";"new path";"new name";"description";"file/folder";"depth";"number of files";"type";"hash (MD5)";"To delete";"tag0 : ${tag2Name}";"tag1 : ${tagName}"`;
      const csvFirstLine = `"";"${formatPathForUserSystem(
        rootFolderId
      )}";"5";"root";"";"10000";"01/01/1970";"01/01/1970";"";"";"";"folder";"0";"1";"folder";"${rootFolderHash}";"";"";""`;
      const csvSecondLine = `"";"${formatPathForUserSystem(
      ...
      const csvThirdLine = `"";"${formatPathForUserSystem(
        ...
        comments[firstChildId]
      }";"file";"2";"1";"plain";"${firstChildIdHash}";"To delete";"${tag2Name}";"${tagName}"`;
      const expectedCsv = [
        csvHeader,
        csvFirstLine,
        csvSecondLine,
